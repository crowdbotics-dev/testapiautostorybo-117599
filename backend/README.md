...
## Project Structure
    ...
    ├── testapiautostorybo_117599  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_117599`
...
2. Clone this repo and `cd testapiautostorybo_117599`
